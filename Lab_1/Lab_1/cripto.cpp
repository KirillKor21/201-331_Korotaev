...
int cripto::encrypt_file(QString file, unsigned char *key) {
    ...
    //    file_data.write(chip_log_pass.toJson());

    //    file_data.close();

    //    qDebug() << chip_log_pass.toJson();
...
QString cripto::decript_file(QString file, unsigned char *key) {
...
int cripto::encrypt(unsigned char *text, int text_len, unsigned char *key,
...
int cripto::decrypt(unsigned char *ciphertext, int ciphertext_len, unsigned char *key,
...
QByteArray cripto::chipr_log_and_pass(QString log, QString pass, unsigned char *key) {
